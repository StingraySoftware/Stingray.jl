...
"""
function get_poisson_level(
    norm::String;
    meanrate::Union{Nothing,Real} = nothing,
    n_ph::Union{Nothing,Real} = nothing,
    backrate::Real = 0.0,
)
...
function avg_pds_from_eventlist(
    eventlist::EventList,
    segment_size::Real,
    dt::Real;
    norm::String = "frac",
...
function avg_cs_from_eventlists(
...
function avg_pds_from_lightcurve(
    lc::LightCurve,
...
function avg_cs_from_lightcurves(
    lc1::LightCurve,
    lc2::LightCurve,
    segment_size::Union{Real,Nothing} = nothing;
    norm::String = "frac",
