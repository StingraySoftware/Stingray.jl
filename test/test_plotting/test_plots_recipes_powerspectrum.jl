...
let
    ...
    mock_ps_no_err =
        (freq = freqs, power = powers, power_err = nothing, norm = "frac", mean_rate = 50.0)
...
let
    ...
    for show_noise in bool_params,
        show_errors in bool_params,
        freq_mult in bool_params,
        log_scale in bool_params
...
let
    ...
    events_dict = Dict("0.5-2 keV" => events_soft, "2-10 keV" => events_hard)
...
let
    ...
    ps_single = (freq = freqs, power = powers, power_err = errors, norm = "leahy", m = 1)
