...
```
"""
function create_synthetic_events(
    n_events::Int = 1000;
    ...
    extra_columns = Dict{String,Vector}("PI" => pi_channels, "DETID" => detector_ids)
...
# Test: Time Ordering
let
    for _ = 1:10  # Test multiple times due to randomness
...
let
    ...
    detid_counts = [count(==(i), events.meta.extra_columns["DETID"]) for i = 0:3]
