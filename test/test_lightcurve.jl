@testset "Complete LightCurve Tests" begin
    ...
    @testset "Properties and Metadata" begin
        ...
        events = EventList{Float64}("test.fits", times, energies, DictMetadata(headers))
    ...
    @testset "Edge Cases" begin
        ...
        empty_events = EventList{Float64}(
            "test.fits",
            Float64[],
            Float64[],
            DictMetadata([Dict{String,Any}()]),
        ...
        single_event = EventList{Float64}(
            "test.fits",
            times,
            energies,
            DictMetadata([Dict{String,Any}()]),
