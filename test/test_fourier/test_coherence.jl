...
let
    ...
    nbins = 2
    C, P1, P2 = @view(test_data.cross[1:nbins]),
    @view(test_data.pds1[1:nbins]),
    @view(test_data.pds2[1:nbins])
    ...
    coh =
        raw_coherence.(low_coh_cross, P1, P2, test_data.p1noise, test_data.p2noise, data.N)
    @test all(iszero, coh)
end
...
let
    ...
    coh_sngl =
        raw_coherence(C[1], P1[1], P2[1], P1noise, P2noise, 499; intrinsic_coherence = 1)
